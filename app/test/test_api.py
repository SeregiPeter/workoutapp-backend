...
def test_get_categories():
    ...
    response = client.get("/categories/", headers={"api_key": API_KEY})
    assert response.status_code == 200
...
def test_get_category_by_id():
    ...
    response = client.get(f"/categories/{category_id}", headers={"api_key": API_KEY})
    assert response.status_code == 200
    assert response.json()["id"] == category_id

def test_get_category_invalid_id():
    response = client.get("/categories/999999", headers={"api_key": API_KEY})
...
def test_delete_category():
    ...
    response = client.delete(f"/categories/{category_id}", headers={"api_key": API_KEY})
    assert response.status_code == 200
    assert response.json()["message"] == "Category has been deleted."

def test_delete_category_invalid_id():
    response = client.delete("/categories/999999", headers={"api_key": API_KEY})
    assert response.status_code == 404
    assert response.json()["detail"] == "Category not found."
...
def test_get_exercise_by_id():
    response = client.get("/exercises/1", headers={"api_key": API_KEY})
    assert response.status_code == 200

def test_get_exercise_invalid_id():
    response = client.get("/exercises/999999", headers={"api_key": API_KEY})
    assert response.status_code == 404

def test_get_all_exercises():
    response = client.get("/exercises/", headers={"api_key": API_KEY})
    assert response.status_code == 200
    assert isinstance(response.json(), list)
...
def test_delete_exercise():
    response = client.delete("/exercises/1", headers={"api_key": API_KEY})
    assert response.status_code == 200

def test_delete_exercise_invalid_id():
    response = client.delete("/exercises/999999", headers={"api_key": API_KEY})
    assert response.status_code == 404
...
def test_delete_category_and_check_exercise():
    ...
    response = client.get(f"/exercises/{exercise_id}", headers={"api_key": API_KEY})
    assert response.status_code == 404
...
def test_get_workout_by_id():
    ...
    get_response = client.get(f"/workouts/{workout_id}", headers={"api_key": API_KEY})
...
def test_delete_workout():
    ...
    delete_response = client.delete(f"/workouts/{workout_id}", headers={"api_key": API_KEY})
...
def test_create_workout_with_exercises():
    ...
    get_workout_response = client.get(f"/workouts/{workout_id}", headers={"api_key": API_KEY})
...
def test_delete_exercise_and_check_workout():
    ...
    delete_response = client.delete(f"/exercises/{exercise_id}", headers={"api_key": API_KEY})
    assert delete_response.status_code == 200

    get_exercise_response = client.get(f"/exercises/{exercise_id}", headers={"api_key": API_KEY})
...
def test_get_challenge():
    ...
    response = client.get(f"/challenges/{challenge_id}", headers={"api_key": API_KEY})
    assert response.status_code == 200
...
def test_delete_challenge():
    ...
    delete_response = client.delete(f"/challenges/{challenge_id}", headers={"api_key": API_KEY})
    assert delete_response.status_code == 200
    assert delete_response.json() == {"message": "Challenge has been successfully deleted."}

    get_response = client.get(f"/challenges/{challenge_id}", headers={"api_key": API_KEY})
    assert get_response.status_code == 404
...
def test_get_challenges_by_exercise():
    ...
    challenges_response = client.get("/challenges/", headers={"api_key": API_KEY})
...
def test_delete_exercise_deletes_challenges():
    ...
    delete_exercise_response = client.delete(f"/exercises/{exercise_id}", headers={"api_key": API_KEY})
    assert delete_exercise_response.status_code == 200

    get_challenge_response = client.get(f"/challenges/{challenge_id}", headers={"api_key": API_KEY})
